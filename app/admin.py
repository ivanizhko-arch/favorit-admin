...
# ---------------------------------------------------------------------------
# Рейтинг менеджеров (метрики для дашборда, п.3 ТЗ 2026-08-24)
# ---------------------------------------------------------------------------
@router.get("/api/manager-metrics")
def admin_manager_metrics(_: str = Depends(get_admin)):
    """Агрегированный рейтинг менеджеров: дела в работе, среднее время
    ответа в чате, NPS, жалобы. Уволенные скрыты."""
